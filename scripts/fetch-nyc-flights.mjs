...
const JSON_PATH = path.join(ROOT, "content", "cities", "newyork", "bookflights.json");
...
const AIRPORT_NAMES = {
  ...
  BOS: "Boston (BOS)", MCO: "Orlando (MCO)", DCA: "Washington (DCA)",
  DFW: "Dallas (DFW)", LAS: "Las Vegas (LAS)", ONT: "Ontario (ONT)",
};
...
function addMinutes(iso, mins) {
  ...
  // New York local time (Eastern), regardless of the origin timezone.
...
async function main() {
  console.log("Fetching cheapest fares to New York...");
  const results = [];
