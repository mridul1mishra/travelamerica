 ...
 *   WEGOTRIP_CITY_ID     - optional, default 5128581 (New York City)
...
const JSON_PATH = path.join(ROOT, "content", "cities", "newyork", "thingstodo.json");
...
const CITY_ID = process.env.WEGOTRIP_CITY_ID || "5128581"; // New York City
...
const AFFILIATE_PATH = path.join(ROOT, "content", "cities", "newyork", "thingstodo.affiliate.json");
let AFFILIATE = {};
try {
