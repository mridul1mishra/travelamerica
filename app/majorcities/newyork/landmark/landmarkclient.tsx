...
export default function LandmarkPage() {
  ...
  const breadcrumb = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 2, "name": "New York", "item": "https://www.travelsamericas.com/majorcities/newyork/" },
      { "@type": "ListItem", "position": 3, "name": "Landmarks", "item": "https://www.travelsamericas.com/majorcities/newyork/landmark" },
    ],
  };
    ...
    <>
      ...
      <section className={styles.relatedLinks}>
        ...
        <div className={styles.linkGrid}>
          ...
          <Link href="/majorcities/newyork/food" className={styles.relatedLink}>
