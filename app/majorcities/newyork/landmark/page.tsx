export const generateMetadata = () => ({
  ...
  alternates: {
      canonical: 'https://www.travelsamericas.com/majorcities/newyork/landmark',
    },
    twitter: {
    ...
    images: ["https://www.travelsamericas.com/data/majorcities/newyork/assets/landmark-banner.png"]
  }
});
