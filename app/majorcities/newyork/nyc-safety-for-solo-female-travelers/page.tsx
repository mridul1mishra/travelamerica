export const generateMetadata = () => ({
  ...
  alternates: {
      canonical: 'https://www.travelsamericas.com/majorcities/newyork/nyc-safety-for-solo-female-travelers',
    },
    twitter: {
    card: "summary_large_image",
    title: 'NYC Safety Scenarios for Solo Female Travelers | Practical, Real‑World Guidance',
    description:  'A scenario‑based NYC safety guide for solo female travelers. Clear, calm steps for navigating subways, stations, and late‑night situations.',
    images: ["https://www.travelsamericas.com/data/majorcities/newyork/assets/nyc-solo-female-traveler-night-safety-banner.jpeg"]
  }
});
