...
const faqData = [
  { question: 'What is the best way to get from MCO to Walt Disney World?', answer: 'For most visitors, a rental car is the most flexible option. If you prefer not to drive, Mears Connect offers shared and private shuttles directly to Disney resorts. Rideshare from MCO to Disney typically runs $30–60 depending on destination and traffic. Disney\'s Magical Express has been discontinued.' },
  { question: 'How far is MCO from Walt Disney World and Universal Studios?', answer: 'MCO is approximately 20–25 minutes from Walt Disney World and 15–20 minutes from Universal Orlando and I-Drive without traffic. Budget more time during peak hours and school holidays.' },
  { question: 'Is Sanford Airport (SFB) a good option for Orlando?', answer: 'SFB is worth considering if you find a much cheaper fare on Allegiant or a charter carrier. But SFB is about 45 miles north of Walt Disney World — a 50-minute drive without traffic. You will need a rental car or pre-booked shuttle; rideshare to Disney from SFB runs $80–120+, and no hotel or Disney shuttles serve SFB.' },
  { question: 'Can I take Brightline to Orlando?', answer: 'Yes — Brightline runs higher-speed trains from Miami, Fort Lauderdale, Boca Raton, and West Palm Beach to a station inside MCO Terminal C. You still need onward transport from MCO to reach Disney or Universal. Check brightline.com for current schedules, as these may change.' },
  { question: 'Is Disney\'s Magical Express still running?', answer: 'No — Magical Express was permanently discontinued in January 2022. The current Disney-area airport shuttle replacement is Mears Connect (mearstransportation.com), offering shared and private options between MCO and Disney properties.' },
