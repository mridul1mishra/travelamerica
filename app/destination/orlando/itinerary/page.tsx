export const metadata = {
  title: 'Orlando 5-Day Itinerary 2026 | Theme Parks + Kennedy Space Center',
  description: 'A practical 5-day Orlando itinerary covering Magic Kingdom, Universal, EPCOT, Hollywood Studios, and Kennedy Space Center — with logistics and booking tips.',
...
export default function OrlandoItineraryPage() { return <OrlandoItineraryClient />; }
