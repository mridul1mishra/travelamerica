  ...
  return (
    <section id="planning-intent" className={styles.section}>
      ...
      <div className={styles.group}>
        ...
        <div className={styles.options}>
          <button className={`${styles.option} ${interest === 'themeparks' ? styles.selected : ''}`}
          onClick={() => setInterest(interest === 'themeparks' ? null : 'themeparks')}>
            Theme Parks
          </button>
          ...
          <button className={`${styles.option} ${interest === 'outdoors' ? styles.selected : ''}`}
          onClick={() => setInterest(interest === "outdoors" ? null : "outdoors")} >
            Springs & Outdoors
          </button>
