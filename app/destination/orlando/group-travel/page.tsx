export const metadata = {
  ...
  openGraph: { title: 'Orlando Group Travel Guide 2026', description: 'How to plan a group trip to Orlando — hotels, park tickets, transport and logistics.', url: 'https://www.travelsamericas.com/destination/orlando/group-travel', type: 'website' },
};
