...
return (
  <>
    <OrlandoNavHeader />
    <BookingCTA variant="slim" text="Book group-friendly Orlando hotels and tickets →" href="/destination/orlando/bookings?tab=hotels&from=group-travel" label="Book group trip" />
