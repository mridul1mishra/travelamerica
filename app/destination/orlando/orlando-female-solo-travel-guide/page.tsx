export const metadata = {
  ...
  openGraph: { title: 'Orlando Female Solo Travel Guide 2026', description: 'Honest guide for women traveling solo to Orlando — safety, parks, and practical advice.', url: 'https://www.travelsamericas.com/destination/orlando/orlando-female-solo-travel-guide', type: 'website' },
};
