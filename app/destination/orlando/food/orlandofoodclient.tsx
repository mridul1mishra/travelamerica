...
const foodCategories = [
  { title: "Sand Lake Restaurant Row", blurb: "The best independent dining in greater Orlando is concentrated on Sand Lake Road between I-4 and Dr. Phillips Blvd. Highlights: The Ravenous Pig (gastropub, local craft beer, excellent burgers), Dragonfly (Japanese robata, $40â€“$60pp), Bosphorous Turkish (a local institution for 20+ years), and Slate (modern American, worth a special dinner). All have bar seating and take reservations.", href: "/destination/orlando/bookings?tab=restaurants" },
  { title: "Theme Park Dining Worth It", blurb: "Most theme park food is overpriced and mediocre â€” but a few are genuinely good. Be Our Guest at Magic Kingdom (lunch walk-up, dinner reservation required) is worth it for the atmosphere. The Wizarding World butterbeer and pumpkin juice at Universal are the real food experiences you can't replicate outside. Epcot's World Showcase pavilions have legitimately good international food â€” La Cantina de San Angel for Mexican, Tangierine CafÃ© for Moroccan.", href: "/destination/orlando/bookings?tab=restaurants" },
  { title: "Disney Springs", blurb: "Disney Springs (free entry) has 60+ dining options from quick service to fine dining. Homecomin' (Southern American, $30â€“$50pp) is genuinely excellent. STK Orlando (steakhouse rooftop) is the splurge option. Wine Bar George has 130+ wines by the glass. Good for a non-park day when you want Disney atmosphere without the admission price.", href: "/destination/orlando/bookings?tab=restaurants" },
  { title: "Local Breakfast & Coffee", blurb: "The Osprey Tavern in Baldwin Park for weekend brunch (local neighbourhood, beautiful lakefront). Se7en Bites Bakery in Milk District (Downtown Orlando) for extraordinary pastries and biscuits â€” cash only, arrive early. Lineage Coffee on Mills Ave is the best specialty coffee in Orlando. The Daily City outdoor market in Orlando runs weekend mornings with a dozen food vendors.", href: "/destination/orlando/bookings?tab=restaurants" },
  { title: "Winter Park Food Scene", blurb: "30 minutes north of I-Drive, Winter Park is a proper walkable town with an exceptional restaurant scene. Luma on Park for fine dining ($80â€“$120pp, book ahead). Prato for Italian in a beautiful Park Avenue setting. The Briarpatch for quintessential Winter Park breakfast and lunch. Hannibal Square has a weekend farmers market every Saturday morning.", href: "/destination/orlando/bookings?tab=restaurants" },
  { title: "Budget & Late Night", blurb: "Hunger Street Tacos on Colonial Dr is the best taco spot in Orlando â€” open until midnight on weekends. Wawa gas stations (a Florida institution) are open 24 hours with surprisingly good hot food for $5â€“$8. ICEBAR Orlando on I-Drive is a gimmick ($20 entry) but the adjacent bar has cheap drinks and food until 2am. Downtown Orlando bars on Orange Avenue serve food until midnight on weekends.", href: "/destination/orlando/bookings?tab=restaurants" },
];
  ...
  return (
    <main>
      ...
      <section className={styles.hero}>
        ...
        <p>Orlando&apos;s food scene extends well beyond theme park food courts. Restaurant Row, Winter Park, and Downtown Orlando have a genuinely strong independent dining scene â€” this guide covers all of it.</p>
      ...
      <section className={styles.section} aria-labelledby="food-or">
        ...
        <p className={styles.sectionIntro}>Six categories covering the full range â€” from theme park splurges to $5 late-night tacos.</p>
      ...
      <BookingCTA
        ...
        text="Reserve tables at top Orlando restaurants â€” from Restaurant Row to Disney Springs."
