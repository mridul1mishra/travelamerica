export const metadata = {
  ...
  openGraph: { title: 'Best Food in Orlando 2026', description: 'Honest Orlando food guide — Restaurant Row, local markets, theme park dining, and where to splurge.', url: 'https://www.travelsamericas.com/destination/orlando/food', type: 'website' },
};
