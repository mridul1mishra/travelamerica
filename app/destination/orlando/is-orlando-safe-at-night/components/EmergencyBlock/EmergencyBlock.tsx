    ...
    <section className={styles.section}>
      <div className={styles.container}>
        ...
        <div className={styles.grid}>
          ...
          <div className={styles.card}>
            <h3 className={styles.title}>🚓 Police Department</h3>
            <a href={nypdPrecinctLocator} className={styles.link} target="_blank" rel="noopener noreferrer">Police Info</a>
          ...
          <div className={styles.card}>
            <h3 className={styles.title}>🚌 Transit & Help</h3>
