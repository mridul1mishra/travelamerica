...
const TAB_RAIL: Record<TabKey, RailConfig> = {
  flights: {
    ...
    guides: [
      { href: "/destination/orlando/getting-around", label: "Getting from MCO airport" },
  ...
  hotels: {
    ...
    guides: [
      ...
      { href: "/destination/orlando/hotel-guide", label: "Orlando hotel guide" },
  ...
  activities: {
    ...
    guides: [
      ...
      { href: "/destination/orlando/theme-parks", label: "Theme park guide" },
      { href: "/destination/orlando/day-trips", label: "Day trips from Orlando" },
    ],
  },
};
...
const RELATED_GUIDE_GROUPS: RelatedGroup[] = [
  {
    ...
    links: [
      { href: "/destination/orlando/things-to-do", label: "Top things to do in Orlando" },
      { href: "/destination/orlando/theme-parks", label: "Orlando theme park guide" },
  ...
  },
  {
    heading: "Explore",
    links: [
      { href: "/destination/orlando/theme-parks", label: "Disney vs Universal guide" },
      { href: "/destination/orlando/food", label: "Where to eat in Orlando" },
      { href: "/destination/orlando/itinerary", label: "3-day Orlando itinerary" },
    ],
  },
];
    ...
    <div className="App">
      ...
      <nav aria-label="Breadcrumb" className={styles.breadcrumb}>
        <ol className={styles.breadcrumbList}>
          ...
          <li className={styles.breadcrumbItem}>
            <a href="/destination/orlando" className={styles.breadcrumbLink}>Orlando</a>
          </li>
          <li aria-hidden="true" className={styles.breadcrumbSep}>›</li>
          <li className={styles.breadcrumbItem}>
      ...
      <h1 className={styles.relatedHeading}>Book Your Orlando Trip</h1>
      ...
      <section className={styles.relatedFooter} aria-label="Related guides">
        <div className={styles.relatedFooterInner}>
          <h2 className={styles.relatedHeading}>Plan your Orlando trip</h2>
