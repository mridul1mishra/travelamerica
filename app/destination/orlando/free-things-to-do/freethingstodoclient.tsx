...
const faqData = [
  ...
  { question: 'Is Disney Springs really free to enter?', answer: 'Yes — completely free to enter and explore. No theme park ticket or reservation required. Parking is free in the Lime and Orange garages (first hour) and free all day in the overflow lots. You only pay for food, shopping, or specific paid attractions inside.' },
  { question: 'Are there free nature experiences near Orlando?', answer: 'Yes. Tibet-Butler Preserve offers a free 0.75-mile boardwalk through Florida wetlands. Lake Apopka Wildlife Drive is free for pedestrians and cyclists — one of Florida\'s best birding spots, especially October through March. Mead Botanical Garden (48 acres) and Kraft Azalea Garden are both free and open daily.' },
  { question: 'Which Orlando museums have free entry?', answer: 'The Charles Hosmer Morse Museum of American Art (world\'s finest Tiffany glass collection) is free on Friday evenings 4–8pm, November through April. The Orange County Regional History Center is free on second Sundays. The Orlando Museum of Art is free on third Thursdays 6–9pm.' },
