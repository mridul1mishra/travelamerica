...
const attractions = [
  { name: "Walt Disney World", blurb: "4 parks: Magic Kingdom, EPCOT, Hollywood Studios, Animal Kingdom. Plan 1 day per park minimum. Buy tickets in advance — prices rise at the gate.", href: "/destination/orlando/bookings?tab=activities" },
  { name: "Universal Orlando Resort", blurb: "Universal Studios + Islands of Adventure. Wizarding World of Harry Potter spans both parks. Early entry is worth the upcharge.", href: "/destination/orlando/bookings?tab=activities" },
  { name: "Kennedy Space Center", blurb: "45 min from Orlando. Real rockets, astronaut stories, and live launch viewing opportunities. Allow a full day.", href: "/destination/orlando/bookings?tab=activities" },
  { name: "Discovery Cove", blurb: "All-inclusive day resort with dolphin swims, snorkeling, and a lazy river. Capacity-limited so it never feels crowded. Book weeks ahead.", href: "/destination/orlando/bookings?tab=activities" },
  { name: "SeaWorld Orlando", blurb: "Beyond the marine shows: Mako, Manta, and Ice Breaker are genuinely excellent coasters. Half-day is enough for most visitors.", href: "/destination/orlando/bookings?tab=activities" },
  { name: "ICON Park (International Drive)", blurb: "The Wheel, Madame Tussauds, and a cluster of attractions on I-Drive. Good for a rainy half-day or evening between park days.", href: "/destination/orlando/bookings?tab=activities" },
];
...
const experiences = [
  { title: "Theme Parks", blurb: "Disney, Universal, SeaWorld, Busch Gardens (Tampa, 90 min away). Multi-day park-hopper passes save money if you're doing 3+ days." },
  { title: "Water Parks", blurb: "Typhoon Lagoon and Blizzard Beach (Disney), Volcano Bay (Universal). Best in summer — lines are shorter on weekday mornings." },
  { title: "Day Trips", blurb: "Kennedy Space Center (45 min), St. Pete Beach (90 min), Tampa (90 min), Busch Gardens (90 min), Everglades airboat tours (3 hr)." },
  { title: "Springs & Outdoors", blurb: "Florida's natural springs — Wekiva, Blue Spring, Silver Springs — are an hour away and worth a half-day escape from the parks." },
];

const whereToStay = [
  { title: "Near Walt Disney World", description: "On-site Disney resorts get 30-min early park entry every day. Off-site hotels on Hotel Plaza Blvd are cheaper and still very close.", href: "/destination/orlando/bookings?tab=hotels" },
  { title: "Near Universal Studios", description: "On-site Loews hotels get Early Park Admission to The Wizarding World. I-Drive hotels are 10 min by car and significantly cheaper.", href: "/destination/orlando/bookings?tab=hotels" },
];

const itineraries = [
  { title: "5-Day Orlando Theme Park Itinerary", description: "Day 1: Magic Kingdom. Day 2: Universal + Islands of Adventure. Day 3: EPCOT. Day 4: Hollywood Studios. Day 5: Kennedy Space Center or water park.", href: "/destination/orlando/bookings" },
  { title: "Orlando Without Kids", description: "EPCOT World Showcase food and wine circuit, Discovery Cove dolphins, Kennedy Space Center, natural springs — the non-thrill-ride side of Orlando.", href: "/destination/orlando/bookings?tab=activities" },
];
    ...
    <main>
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroCtas}>
          <Link href="/destination/orlando/bookings?tab=flights" className={styles.primaryCta}>Compare flights to MCO</Link>
      ...
      {/* Why Orlando */}
      <section className={`${styles.section} ${styles.altBg}`} aria-labelledby="why-orlando">
      ...
      {/* Top Attractions */}
      <section className={styles.section} aria-labelledby="attractions-orlando">
        ...
        <Link href="/destination/orlando/bookings?tab=activities" className={styles.seeAll}>See all things to do in Orlando →</Link>
      </section>

      {/* Neighborhoods */}
      <section id="neighborhoods" className={`${styles.section} ${styles.altBg}`} aria-labelledby="neighborhoods-orlando">
      ...
      {/* Experiences */}
      <section className={styles.section} aria-labelledby="experiences-orlando">
      ...
      <section className={`${styles.section} ${styles.altBg}`} aria-labelledby="hotels-orlando">
      ...
      {/* Itineraries */}
      <section className={styles.section} aria-labelledby="itineraries-orlando">
