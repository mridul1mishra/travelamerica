export const metadata = {
  ...
  openGraph: { title: 'Solo Trip to LA 2026 | Complete Guide', description: 'Everything a first-time solo traveler needs to know about visiting Los Angeles.', url: 'https://www.travelsamericas.com/destination/la/solo-trip-to-la', type: 'website' },
};
