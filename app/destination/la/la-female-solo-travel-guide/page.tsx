export const metadata = {
  ...
  openGraph: { title: 'LA Female Solo Travel Guide 2026', description: 'Honest guide for women traveling solo to Los Angeles — safety, neighborhoods, and practical advice.', url: 'https://www.travelsamericas.com/destination/la/la-female-solo-travel-guide', type: 'article' },
};
