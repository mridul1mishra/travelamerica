...
export const SCENARIOS: readonly Scenario[] = [
  // STREET
  {
    ...
    content: [
      "Stick to walkable areas like Santa Monica and WeHo",
  ...
  {
    id: 4,
    title: "Walking to an Isolated Parking Structure",
    content: [
      "Ask hotel or venue staff to escort you",
      "Have your keys ready before you reach the car",
      "Park in well-lit, populated spots",
  ...
  {
    id: 5,
    title: "Late-Night Metro Ride",
    content: [
      "Avoid empty cars even if convenient",
      "Stand near other riders",
      "Keep your bag in front",
      "Use rideshare instead after 10pm"
    ],
    category: "Transit"
  },
  {
    id: 6,
    title: "Confusing Metro Exits",
    content: [
  ...
  {
    id: 8,
    title: "Car Break-In Awareness",
    content: [
      "Never leave anything visible in your car",
      "Park in attended or well-lit lots",
      "Photograph damage before moving anything",
      "Report break-ins to police and rental company"
    ],
    category: "Transit"
  },
  ...
  {
    id: 16,
    title: "Nightlife in WeHo & Santa Monica",
    content: [
      "Choose venues with visible security",
      "Keep your drink in hand or covered",
      "Don't accept drinks you haven't seen poured",
      "Walk to a rideshare pickup on the main street"
    ],
    category: "Social"
  }
] as const;
