export const metadata = {
  ...
  openGraph: { title: 'LA Metro Safety Guide 2026', description: 'Is the LA Metro safe? Honest guide for tourists — which lines, which times, and what to watch for.', url: 'https://www.travelsamericas.com/destination/la/metro-safety-guide', type: 'article' },
};
