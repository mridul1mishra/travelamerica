export const metadata = {
  ...
  openGraph: { title: 'Los Angeles 3-Day Itinerary 2026', description: 'Day-by-day LA itinerary built around real logistics — not an aspirational list.', url: 'https://www.travelsamericas.com/destination/la/itinerary', type: 'website' },
};
