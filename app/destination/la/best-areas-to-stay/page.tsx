export const metadata = {
  ...
  openGraph: { title: 'Best Areas to Stay in Los Angeles 2026', description: 'Honest neighborhood comparison for LA — Santa Monica, Hollywood, Silver Lake, DTLA and beyond.', url: 'https://www.travelsamericas.com/destination/la/best-areas-to-stay', type: 'website' },
};
