  ...
  return (
    <section id="planning-intent" className={styles.section}>
      ...
      <div className={styles.group}>
        ...
        <div className={styles.options}>
          <button className={`${styles.option} ${interest === 'beaches' ? styles.selected : ''}`}
          onClick={() => setInterest(interest === 'beaches' ? null : 'beaches')}>
            Beaches &amp; Outdoors
          </button>

          <button className={`${styles.option} ${interest === 'film' ? styles.selected : ''}`}
          onClick={() => setInterest(interest === "film" ? null : "film")} >
            Film &amp; Pop Culture
          </button>
          <button className={`${styles.option} ${interest === 'food' ? styles.selected : ''}`}
          onClick={() => setInterest(interest === "food" ? null : "food")} >
            Food &amp; Neighborhoods
          </button>
          <button className={`${styles.option} ${interest === 'museums' ? styles.selected : ''}`}
          onClick={() => setInterest(interest === "museums" ? null : "museums")} >
            Museums &amp; Culture
          </button>
        </div>
      </div>
