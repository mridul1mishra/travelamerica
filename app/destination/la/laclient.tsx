...
const TAB_RAIL: Record<TabKey, RailConfig> = {
  ...
  hotels: {
    nextStep: { label: "Next: things to do in Los Angeles →", toTab: "activities" },
  },
  activities: {
    ...
    <div className="App">
      ...
      <nav aria-label="Breadcrumb" className={styles.breadcrumb}>
        <ol className={styles.breadcrumbList}>
          ...
          <li className={styles.breadcrumbItem}>
            <span aria-current="page" className={styles.breadcrumbCurrent}>Los Angeles</span>
          </li>
        </ol>
      </nav>
      ...
      {/* Tab-aware Next-step rail — no guide links for LA */}
      {(() => {
