...
const TAB_RAIL: Record<TabKey, RailConfig> = {
  flights: {
    ...
    guides: [
      { href: "/destination/lasvegas/getting-around", label: "Getting from LAS airport" },
  ...
  hotels: {
    ...
    guides: [
      ...
      { href: "/destination/lasvegas/hotel-guide", label: "Las Vegas hotel guide" },
  ...
  activities: {
    ...
    guides: [
      ...
      { href: "/destination/lasvegas/shows", label: "Best shows in Las Vegas" },
      { href: "/destination/lasvegas/day-trips", label: "Day trips from Las Vegas" },
    ],
  },
};
...
const RELATED_GUIDE_GROUPS: RelatedGroup[] = [
  {
    ...
    links: [
      { href: "/destination/lasvegas/things-to-do", label: "Top things to do in Las Vegas" },
      { href: "/destination/lasvegas/shows", label: "Best shows on the Strip" },
  ...
  },
  {
    heading: "Explore",
    links: [
      { href: "/destination/lasvegas/things-to-do", label: "Grand Canyon & Hoover Dam tours" },
    ...
    <div className="App">
      ...
      <nav aria-label="Breadcrumb" className={styles.breadcrumb}>
        <ol className={styles.breadcrumbList}>
          ...
          <li className={styles.breadcrumbItem}>
            <a href="/destination/lasvegas" className={styles.breadcrumbLink}>Las Vegas</a>
          </li>
          <li aria-hidden="true" className={styles.breadcrumbSep}>›</li>
          <li className={styles.breadcrumbItem}>
      ...
      <section className={styles.relatedFooter} aria-label="Related guides">
        <div className={styles.relatedFooterInner}>
          <h2 className={styles.relatedHeading}>Plan your Las Vegas trip</h2>
