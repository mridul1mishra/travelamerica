export const metadata = {
  ...
  openGraph: { title: 'Solo Trip to Las Vegas 2026 | Complete Guide', description: 'Complete guide for solo travelers visiting Las Vegas — honest, practical, no fluff.', url: 'https://www.travelsamericas.com/destination/lasvegas/solo-trip-to-lasvegas', type: 'website' },
};
