...
return (
    <>
        <Header image={`/data/majorcities/lasvegas/assets/group/lasvegas-group-travel-packing-flatlay-essentials.webp`} bannerText="Flatlay of Las Vegas group travel essentials including backpack, sunglasses, monorail pass, sneakers, and a Strip map" variant="wide" />
