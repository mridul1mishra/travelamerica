export const metadata = {
  ...
  openGraph: { title: 'Is Las Vegas Safe in 2026?', description: 'Real Las Vegas safety advice — scams, neighborhoods, heat, and nightlife safety.', url: 'https://www.travelsamericas.com/destination/lasvegas/safety-guide', type: 'article' },
};
