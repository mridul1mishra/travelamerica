export const metadata = {
  title: 'Best Areas to Stay in Las Vegas 2026 | Strip vs Downtown vs Off-Strip',
  description: 'Where to stay in Las Vegas — Strip hotel tiers, Downtown Fremont, Henderson, and Summerlin compared. Practical advice for every budget and trip type.',
...
export default function LasVegasBestAreasPage() { return <LasVegasBestAreasClient />; }
