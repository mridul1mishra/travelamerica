...
export default function RecommendationsPreview({
  ...
  const thingsHref =
    ...
    : interest === 'daytrips' ? '/destination/lasvegas/landmark'
    ...
    >
      ...
      <div className={styles.grid}>
        ...
        <div className={styles.card}>
          ...
          <p>
            Vegas areas that work well for your stay length and travel style.
          </p>
          <Link
      ...
      <div className={styles.nextStep}>
        <button className={styles.primaryCta}>
          Get a personalized Las Vegas itinerary
        </button>
      </div>
    </section>
  );
