    ...
    <section id="planning-intent" className={styles.section}>
      ...
      <div className={styles.group}>
        ...
        <div className={styles.options}>
          ...
          <button className={`${styles.option} ${interest === 'gaming' ? styles.selected : ''}`}
          onClick={() => setInterest(interest === "gaming" ? null : "gaming")} >
            Casinos &amp; Gaming
          </button>
          ...
          <button className={`${styles.option} ${interest === 'daytrips' ? styles.selected : ''}`}
          onClick={() => setInterest(interest === "daytrips" ? null : "daytrips")} >
            Day Trips &amp; Outdoors
          </button>
        </div>
      </div>
