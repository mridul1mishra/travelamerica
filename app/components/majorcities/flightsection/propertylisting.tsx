...
// Previously this component fetched hotels.json and cruises.json over HTTP
// from /data/majorcities/${city}/. The JSON has moved into the build-time
// content/ tree and is now passed in as props from the [city] server page,
// so the useEffect + fetch is gone.
type SectionsProps = {
  active: number | null;
...
const Propertylisting: React.FC<SectionsProps> = ({ content, active, hotels, cruises }) => {
